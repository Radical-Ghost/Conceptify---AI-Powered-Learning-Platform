...
const Dashboard = ({ user, handleLogout, chatMessages }) => {
		...
		<div className="dashboardContent">
			<div className="dashboardHeader">
				...
				<p className="dashboardSubtitle">
					Your recent learning activities and chat history
				</p>
			</div>
				...
				<div className="chatHistoryGrid">
					{recentChats.map((chat) => (
						<div
							...
							onClick={() =>
								chat.id === 0 ? navigate("/chatbot") : null
							}>
			...
			{recentChats.length === 0 && (
				<div className="emptyState">
					...
					<p>
						Start a conversation with the AI to see your history
						here
					</p>
					<button
